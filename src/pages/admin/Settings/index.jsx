...
const SettingsForm = ({ initialSettings, updateSettings, clearAllLogs, resetAllData, exportDatabase }) => {
    ...
    const handleSave = async () => {
        ...
        if (result?.success === false) showSnack(`Failed to save: ${result.error}`, 'error');
        else showSnack('Settings saved successfully');
    };
    ...
    const handleConfirm = async () => {
        ...
        } else if (dialog.type === 'reset_data') {
    ...
    const dialogConfig = {
        ...
        reset_data: {
            ...
            description: 'This will permanently delete all activity logs, events, courses, attendance, grades, and enrollments. Users will NOT be deleted. This cannot be undone.',
        ...
        <Box>
            ...
            {current && (
                <ConfirmDialog
                    ...
                    confirmColor={current.confirmColor}
